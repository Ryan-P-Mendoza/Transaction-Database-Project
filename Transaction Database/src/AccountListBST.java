public class AccountListBST<E extends Comparable<E>>{
    ...
    public boolean search(E e) {
        ...
        System.out.printf("Account %s does not exist in the bank database!", e);
        return false; // Element is not in the tree
    }

    
    public boolean insert(E e,Account a) {
    ...
    // When we need to create a new BST node we just created a new tree node from the AccountNode class
    protected AccountNode<E> createNewNode(E e) {
        return new AccountNode<>(e);
    }
    ...
    protected void inorder(AccountNode<E> root) {
        ...
        AccountsNode<Account> artRec = root.head; // we will then start printing the linked list tied to that node at the head
    ...
    protected void print(AccountNode<E> t){
        ...
        AccountsNode<Account> artRec = root.head; // Then like the inOrder printing we start printing out articles starting at the head of the linked list
